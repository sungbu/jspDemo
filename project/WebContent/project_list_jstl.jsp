...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <%--   <%
           List<Project> p = (List<Project>)request.getAttribute("list");
          for(int i=0;i<p.size();i++){
           
      %>     
      <tr>
         <td width="33%" height="30" align="center" bgcolor="#FFF5D7"><span class="txt"><%=p.get(i).getProjectId() %></span></td>
        <td width="34%" height="30" align="center" bgcolor="#FFF5D7"><span class="txt"><%=p.get(i).getProjectName() %></span></td>
        <td width="33%" height="30" align="center" bgcolor="#FFF5D7"><span class="txt"><a href="ProjectServlet?opr=edit&id=<%=p.get(i).getProjectId() %>">【修改】</a><a href="javascript:mysq('<%=p.get(i).getProjectId() %>')">【删除】</a></span></td>
      </tr>
