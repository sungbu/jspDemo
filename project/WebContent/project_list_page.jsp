...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="30" colspan="3"><table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
      <a href="ProjectPageServlet?page=1">首页</a>
      <a href="ProjectPageServlet?page=${page.currPageNo-1}">上一页</a>
     <a href="ProjectPageServlet?page=${page.currPageNo+1}">下一页</a>
     <a href="ProjectPageServlet?page=${page.totalPageCount}">末页</a>      
      </tr>
